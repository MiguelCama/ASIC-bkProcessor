...
set TOP "bkProcessor"
set FILE_HDL "projectMiguel.v"
set UPF_file "projectMiguel.upf"
set SDC_file "projectMiguel.sdc"
set Project_lib "projectMiguel.db"
...
# Exit
# Execute ---- >icc2_shell -f scripts/icc2.tcl | tee -i logs/icc2.log